...
class MultilineRenderer implements FieldRendererInterface
{
    ...
    public function render(AddressFieldAttributes $attributes): string
    {
        ...
        $block = $this->layout->createBlock(FieldRenderer::class)
            ->setTemplate('MageHx_MahxCheckout::ui/address/fields/multiline.phtml');
    ...
    {
        return $attributes->type === 'multiline';
    }
}
